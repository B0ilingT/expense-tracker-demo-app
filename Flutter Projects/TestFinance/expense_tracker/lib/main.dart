...
var kColourScheme =
    ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 96, 59, 181), onBackground: const Color.fromARGB(255, 223, 214, 243));

var kDarkColourScheme =
      ...
      darkTheme: ThemeData.dark().copyWith(
          ...
          textTheme: ThemeData().textTheme.copyWith(
                ...
                labelMedium: TextStyle(
                  color: kDarkColourScheme.primaryContainer,
                ),
              )),
